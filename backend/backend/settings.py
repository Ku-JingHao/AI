...
# CORS settings - allow React development server to access the API
...
# Groq API settings
GROQ_API_KEY = os.getenv("GROQ_API_KEY", "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")
