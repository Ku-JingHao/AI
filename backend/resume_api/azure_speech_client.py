...
SPEECH_KEY = os.getenv("AZURE_SPEECH_KEY", "BRSNZiVwft5xHRt7mDe13KHWiseJRlTKSzYraMvoHFnuywfJ37gPJQQJ99BCACqBBLyXJ3w3AAAYACOGCVA8")
SPEECH_ENDPOINT = os.getenv("AZURE_SPEECH_ENDPOINT", "https://southeastasia.api.cognitive.microsoft.com/")
